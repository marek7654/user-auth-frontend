    ...
    <>
      <Hero title='Witaj!'>
        <p className='col-md-8 fs-4'>
          Przykładowa frontendowa aplikacja stworzona z pomocą ReactJS
          oraz&nbsp;Bootstrap 5.
        </p>
      </Hero>
      <div className='row align-items-md-stretch'>
        <Column colClasses='col-md-6 pb-4' title='Zaloguj się' darkTheme={true}>
          <p>
            Zaloguj się, aby mieć dostęp do treści znajdujących się na serwerze.
          </p>
          <Button
            link='login'
            title='Zaloguj się'
